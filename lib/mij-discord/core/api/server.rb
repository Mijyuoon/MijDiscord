...
module MijDiscord::Core::API::Server
  class << self
    ...
    def create_channel(token, server_id, name, type, bitrate, user_limit, permissions, nsfw, reason = nil)
      MijDiscord::Core::API.request(
        :guilds_sid_channels,
        server_id,
        :post,
    ...
    def update_channel_position(token, server_id, channel_id, position, reason = nil)
      MijDiscord::Core::API.request(
        :guilds_sid_channels,
        server_id,
        :patch,
    ...
    def update_member(token, server_id, user_id, reason = nil, nick: nil, roles: nil, mute: nil, deaf: nil, channel_id: nil)
      MijDiscord::Core::API.request(
        :guilds_sid_members_uid,
        server_id,
        :patch,
    ...
    # https://discordapp.com/developers/docs/resources/guild#get-guild-roles
    def create_role(token, server_id, name, color, hoist, mentionable, permissions, reason = nil)
      MijDiscord::Core::API.request(
        :guilds_sid_roles,
        server_id,
        :post,
    ...
    def update_role(token, server_id, role_id, name, color, hoist, mentionable, permissions, reason = nil)
      MijDiscord::Core::API.request(
